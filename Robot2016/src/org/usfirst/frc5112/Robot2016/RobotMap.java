...
public class RobotMap {
    ...
    public static CANTalon driveTrainLeftDriveMotor;
    public static CANTalon driveTrainRightDriveMotor;
    ...
    public static void init() {
        ...
        LiveWindow.addActuator("Drive Train", "Left Drive Motor", driveTrainLeftDriveMotor);
        
        driveTrainRightDriveMotor = new CANTalon(1);
        LiveWindow.addActuator("Drive Train", "Right Drive Motor", driveTrainRightDriveMotor);
