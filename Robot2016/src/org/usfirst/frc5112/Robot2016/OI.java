...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("Operate Drive Train", new OperateDriveTrain());
        SmartDashboard.putData("Set Hood Position", new SetHoodPosition());
        ...
        SmartDashboard.putData("Store Boulder", new StoreBoulder());
        SmartDashboard.putData("Autonomous Cross Rough Terrain", new AutonomousCrossRoughTerrain());
        SmartDashboard.putData("Display Normal Camera Image", new DisplayNormalCameraImage());
        SmartDashboard.putData("Locate Target", new LocateTarget());
        SmartDashboard.putData("Align With Target", new AlignWithTarget());
        SmartDashboard.putData("Rotate To Target", new RotateToTarget());
